...
import { ArrowLeft, Heart, Share2, ChevronRight, Star, Phone, Clock, Shirt } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col pb-28">
      ...
      <div className="px-4 pt-4 flex flex-col gap-4">
        ...
        {/* Name */}
        <div>
          <h1 className="text-michelin-black font-bold text-3xl leading-tight">Le Clarence</h1>
          <p className="text-michelin-gray text-sm mt-1">
            Paris 8<sup>e</sup> · Française moderne · €€€€
          </p>
          <div className="flex items-center gap-1 mt-1.5">
            <Heart size={13} fill="#E4002B" stroke="none" />
            <span className="text-michelin-black text-sm font-semibold">4.8</span>
            <span className="text-michelin-gray text-sm">(1 284 avis) · À 650 m</span>
          </div>
        </div>

        {/* Description */}
        <p className="text-michelin-black text-sm leading-relaxed">
          Dans un hôtel particulier du 8<sup>e</sup>, le chef Christophe Pelé signe une cuisine précise
          et inspirée, où chaque produit trouve sa juste place.
        </p>
